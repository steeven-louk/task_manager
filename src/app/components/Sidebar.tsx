           ...
           <div className="list-link flex h-full">
            <nav className="link flex flex-col my-auto w-full">
               <ul className='capitalize transition'>
                    <li className="nav-item hover:border-r-2 text-xl leading-10 hover:bg-slate-500 border-green-500"><a href="#" className="nav-link">dashboard</a></li>
                    <li className="nav-item hover:border-r-2 text-xl leading-10 hover:bg-slate-500 border-green-500"><a href="#" className="nav-link">my tasks</a></li>
