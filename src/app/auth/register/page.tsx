    ...
    <div className='container grid place-items-center '>
        <form action="" className='form min-w-fit w-1/3  shadow-lg rounded-lg p-5 border-2 border-red-500'>
          ...
          <div className="input-group flex flex-col">
            ...
            <input type="text" name='username' placeholder='username' className='input-control p-2 rounded-md border-b-2 border-green-500' />
           </div>
           <div className="input-group flex flex-col">
           ...
           <div className="input-group flex flex-col">
            ...
            <input type="text" name='cpassword' placeholder='confirm password' className='input-control p-2 rounded-md border-b-2 border-green-500' />
           </div>
          </div>
